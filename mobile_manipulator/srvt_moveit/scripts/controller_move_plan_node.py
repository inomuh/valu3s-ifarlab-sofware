...
class MovePlanController():
    ...
    def dynamic_go_to_pose_goal(self):
        ...
        try:
            ...
            y_value = input("Y Coordinate Value = ")
            z_value = input("Z Coordinate Value = ")
            roll_value = input("Roll Value = ")
            pitch_value = input("Pitch Value = ")
            yaw_value = input("Yaw Value = ")
            ...
            print(pose_goal)
            or_pose = quaternion_from_euler(float(roll_value), float(pitch_value), float(yaw_value))
