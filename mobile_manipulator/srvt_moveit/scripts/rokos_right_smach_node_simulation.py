...
import rokos_smach_lib_simulation as rsl
        ...
        with sm_top:
            ...
            with sm_move_con:
                ...
                smach.StateMachine.add('Mobile_Platform_Move',
                 rsl.MobilePlatformMoveState(rokos_right_class),
                ...
                smach.StateMachine.add('Manipulator_Move',
                 rsl.ManipulatorMoveState(rokos_right_class),
                                    transitions={'succeeded':'General_Selection',
                ...
                smach.StateMachine.add('Rokos_Right_Take_Photo',
                 rsl.RokosTakePhotoState("right_rokos_image_service",rokos_right_class),
                                    transitions={'succeeded':'General_Selection',
                ...
                smach.StateMachine.add('Emergency',
                 rsl.EmergencyState(rokos_right_class),
                                    transitions={'succeeded':'General_Selection',
                                                 'aborted':'Emergency'},
                                    remapping={ 'task_input':'task',
                                                'task_output':'task',
                ...
                smach.StateMachine.add('ManuelState',
                 rsl.ManuelState(rokos_right_class),
                                    transitions={'succeeded':'General_Selection',
                                                 'aborted':'ManuelState',
                                                 'emg_stop': 'Emergency',
